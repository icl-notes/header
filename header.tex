...
% Integrals
\newcommand{\intd}[4]{\int_{#1}^{#2} \, #3 \, \dif #4}
\newcommand{\iintd}[4]{\iint_{#1} \, #2 \, \dif #3 \, \dif #4}
\newcommand{\iiintd}[5]{\iiint_{#1} \, #2 \, \dif #3 \, \dif #4 \, \dif #5}
...
\newcommand{\g}{\mathfrak{g}}    % Fraktur g
...
\renewcommand{\l}{\mathfrak{l}}  % Fraktur l
